...
def parse_config():
    ...
    parser.add_argument('--_2dpass_checkpoint', type=str, default=None, help='checkpoint for pretrained model')
    parser.add_argument('--num_pred', type=str, default=0, help='Number of sample predictions to save')
    # debug
