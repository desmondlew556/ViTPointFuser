...
class point_image_dataset_nus(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        data_dict['img_label'] = img_label
        data_dict['point2img_index'] = point2img_index
        data_dict['detected_obj_data'] = data['detected_obj_data']
        data_dict['num_vote'] = data['num_vote']
...
def collate_fn_default(data):
    collated_detected_obj = {}
    if data[0]['num_vote']<=1:
    ...
    return {
        ...
        'path': path,
        'detected_obj_data':collated_detected_obj,
        'token':data[0]['token'],
    }
