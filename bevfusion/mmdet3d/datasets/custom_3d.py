...
class Custom3DDataset(Dataset):
    ...
    def pre_pipeline(self, results):
        ...
        results["save_detection_results"] = self.save_detection_results
        file_path = osp.basename(self.ann_file)
        file_name,_ = osp.splitext(file_path)
        mode = file_name[15:]
        results["dataset_split"] = mode
